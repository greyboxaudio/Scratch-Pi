...
#define METER_WARNING_TIME 30 /* time in seconds for "red waveform" warning */
...
static SDL_Color background_col = {41, 41, 41, 255},
    text_col = {204, 204, 204, 255},
    alert_col = {153, 51, 0, 255}, // remaining < meter warning time
    ok_col = {255, 255, 255, 255}, // remaining > meter warning time
    //elapsed_col = {235, 190, 38, 255}, //yellow
    //elapsed_col = {30, 166, 201, 255}, // blue
    elapsed_col = {0, 102, 153, 255}, // waveform
    cursor_col = {255, 211, 0, 255}, //search window
    selected_col = {153, 51, 0, 255}, //library selected
                        ...
                        struct selector *sel)
{
    ...
    s = draw_text(surface, &rtext, buf, font, library_col_bg, search_col_bg);
                            ...
                            const struct listbox *scroll)
{
    ...
    if (scroll->entries > 0) {
        ...
        SDL_FillRect(surface, &box, palette(surface, &scrollbar_col));
    }
}
                         ...
                         const void *context, draw_row_t draw)
{
    ...
    draw_rect(surface, &remain, library_col_bg);
}
